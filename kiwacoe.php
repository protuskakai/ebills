...
//$pa=$yr.$mon.$reg;
$n=0;
$sql = "select a.*,amtt as amt from saccodb a,sms_sh b where a.membid=b.membid and stat='1' and telno like '%7%' order by membid  LIMIT 0,1";
...
$text="Message from KIWACOE, Dear ".$nam.": Your shares balance =".$amt;
 //$dr= $book['nos'];
//$to=$dr;     //254717411083;
$action="send";
$sender="ConectMedia";
