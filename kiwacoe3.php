...
$sql2=" select  typ,sum(bal+intramt-ramt+adj) as amtt2 FROM `loan_rpt2`  where membid='$custid' and CONCAT(yr,mon)='$hyrmon' group by typ";
//echo $sql2;
