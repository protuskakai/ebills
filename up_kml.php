...
echo "max=".$max;
//$result = mysqli_query($dbi,"select * from customer_accounts where entid>$max and  left(customerid,1)='5' order by entid  ");
$sql="select * from Customer_accounts where entid>$max and  left(customerid,1)='5' order by entid limit 0,10000";
echo "<br>";
echo "<br>";
//echo $sql; 
...
$sql2 = "select max(entid) as ent from Customer_accounts  where left(customerid,1)='5'";
